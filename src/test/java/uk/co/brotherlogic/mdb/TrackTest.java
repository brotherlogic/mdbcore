...
public class TrackTest extends TestCase {
	...
	public void buildTrackForTest() {
		if (!built) {
			...
			try {
				...
				Record r2 = GetRecords.create().getRecords(
						"fake-tracks-testing").get(0);
	...
	public void testFormTrack() {
		...
		try {
			...
			Record r2 = GetRecords.create().getRecords("fake-titles-format")
					.get(0);
	...
	public void testFormTrackArtist() {
		try {
			buildTrackForTest();
			Record nrec = GetRecords.create().getRecords("fake-tracks-testing")
					.get(0);
